...
- Fill the `SSH public key` field of your [intranet profile](https://alx-intranet.hbtn.io/users/my_profile) with the public key you just generated
...
- [8 in the Chinese culture](https://en.wikipedia.org/wiki/Chinese_numerology#Eight)
